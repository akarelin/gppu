"""gppu.iot — provider: IoT value types and serialized device controls, from gppu 3 iot.py.
...
JSONHTTPControl make a request each. The MQTT transport that shared the file is gppu.mqtt.
"""
