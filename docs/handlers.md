...
## `DataObject(uri: 'y2uri', content: 'dict[str, Any] | list[Any] | str | int | float | bool | None | bytes | BinaryIO', identity: 'str | None', kind: 'str' = 'object', name: 'str' = '', parent: "'DataObject | None'" = None, removed: 'bool' = False) -> None`
...
## `Provider(connection: 'Mapping[str, Any] | None' = None) -> 'None'`
...
### `Provider.walk(self, uri: 'y2uri', path: 'y2path | str' = '', *, level: 'str' = 'files', recursive: 'bool' = False, boundaries: 'Iterable[y2path | str]' = ()) -> 'Iterator[tuple[dict, list[dict]]]'`
...
### `Provider.refresh(self, state: 'dict[str, Any]', uri: 'y2uri') -> 'Iterator[tuple[Iterator[DataObject], Callable[[], None]]]'`

The objects changed at or below uri since state was recorded, and a callback that records the new state.

### `Provider.locations(self, uri: 'y2uri') -> 'list[tuple[str, str]]'`
...
## `Container(provider: 'Provider', uri: 'y2uri | str', *, templates: 'Mapping[str, str] | None' = None) -> 'None'`
...
### `Container.ls(self, path: 'y2path | str' = '', detail: 'bool' = True) -> 'list[dict[str, Any]] | list[str]'`
...
### `Location.ls(self) -> "list['Location']"`
...
### `GppuCatalog.location_of(self, uri: 'y2uri | str') -> 'tuple[Location, y2path]'`
...
## `Collection(load: 'Callable[[], GppuCatalog]', store: 'Callable[[Location | None, str, dict[str, Any]], None]') -> 'None'`
...
### `Collection.add(self, who: 'str', **fields: 'Any') -> 'None'`
...
### `Collection.location(self, uid: 'str') -> 'Location'`

The configured Location with uid.

### `Collection.location_of(self, uri: 'y2uri | str') -> 'tuple[Location, y2path]'`

The Location a uri falls under, and the path below it.

### `Collection.config(self, table: 'str | None' = None) -> 'list[str] | dict[str, dict[str, Any]]'`
...
### `Collection.ls(self, uri: 'y2uri | str', detail: 'bool' = True) -> 'list[dict[str, Any]] | list[str]'`

What is directly inside uri.

### `Collection.walk(self, uri: 'y2uri | str', level: 'str' = 'files', recursive: 'bool' = False) -> 'list[tuple[dict, list[dict]]]'`

Every folder at and below uri with what it holds, read as deep as level.

### `Collection.info(self, uri: 'y2uri | str') -> 'dict[str, Any]'`

What the handlers found at uri, without its content.

### `Collection.read(self, uri: 'y2uri | str') -> 'DataObject'`

The object at uri with its content.

### `Collection.open(self, uri: 'y2uri | str', mode: 'str' = 'rb') -> 'BinaryIO'`

The bytes at uri.

### `Collection.write(self, uri: 'y2uri | str', obj: 'DataObject') -> 'None'`

Store obj at uri.

### `Collection.delete(self, uri: 'y2uri | str') -> 'None'`
...
## `walk_container(container, path, level, recursive, boundaries)`

The same enumeration contract for non-filesystem Containers.

## `walk_files(root: 'Path', path: 'str', level: 'str', recursive: 'bool', boundaries: 'Iterable[str]') -> 'Iterator[tuple[dict, list[dict]]]'`

Read through the handlers, extracting each selected archive once per walk.

## `serve(lake: 'Collection', host: 'str' = '127.0.0.1', port: 'int' = 8765) -> 'None'`
