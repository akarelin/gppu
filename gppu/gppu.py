...
# region Vault: secrets, and what ``!secret`` in a configuration file resolves through. AZURE_KEYVAULT_NAME selects
# Azure Key Vault (needs the ``vault`` extra); SECRET_<NAME> environment variables are read first.
class VaultProvider:
