"""gppu.data — databases and local persistence: _PGBase for apps that inherit a database, Postgres as a Connection,
Cache and Persistence with their json, sqlite, pickle, diskcache and database backends."""
from __future__ import annotations

from contextlib import contextmanager
from typing import Any, ClassVar, Iterator, Optional

from .connections import Provider
