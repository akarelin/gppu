...
| `gppu.session` | Session readers for Codex and Claude Code logs, registered on import: `Session` (ids, models, turns) and `SessionMeta.of(*sessions)` (span, models, turns). |
